...
app.post('/api/order', async (req, res) => {
  try {
    ...
    // Dhan's plain order endpoint (not Super Order) supports productType
    // "CO" — a real Cover Order: your entry plus one automatic stop-loss
    // leg, no target required. The stop-loss goes in "triggerPrice", per
    // Dhan's documented order fields.
    const orderPayload = {
    ...
    const r = await dhanFetch(`${BASE}/orders`, {
      method: 'POST',
      headers: HEADERS(),
